...
print("Submitting to problem 2672...")
try:
    response = requests.post(f"{api_base}/problem/2672/submit", headers=headers, data=data, timeout=30)
    ...
    if response.status_code == 200 or response.status_code == 201:
        ...
        if 'id' in result:
            ...
            print(f"\nSubmission ID for problem 2672: {submission_id}")
            with open('/workspace/submission_ids.log', 'a') as f:
                f.write(f"2672: {submission_id}\n")
